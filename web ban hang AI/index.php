<?php
session_start(); // Khởi động session để lấy thông tin user đã lưu
?>
<!DOCTYPE html>
<html lang="vi">
...
<body>
    ...
    <nav class="glass-header">
        <div class="header-left">
            ...
            <div class="main-menu">
                ...
                <a href="#products" class="menu-item">Sản phẩm</a>
            </div>
        </div>

        <div class="smart-search">
            <i class="fa-solid fa-search"></i>
            <input type="text" placeholder="Tìm kiếm trang phục, phụ kiện...">
        ...
        <div class="nav-links">
            ...
            <div class="auth-group">
                <?php if (isset($_SESSION['customer_id'])): ?>
                    <a href="#" class="menu-item">Chào, <strong style="color: var(--accent-blue);"><?php echo htmlspecialchars($_SESSION['username']); ?></strong></a>
                    <a href="logout.php" class="nav-icon" title="Đăng xuất">
                        <i class="fa-solid fa-right-from-bracket" style="font-size: 1.5rem; color: #ff4d4d;"></i>
                    </a>
                <?php else: ?>
                    <a href="login.html" class="menu-item">Đăng ký | Đăng nhập</a>
    ...
    <!-- Footer Simple -->
    <footer>
        <p>&copy; 2026 NovaStore. Trải nghiệm mua sắm của tương lai.</p>
    </footer>
